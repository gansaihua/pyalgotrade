...
class FixedPerShare(Commission):
    """A :class:`Commission` class that charges a fixed amount for one share.
    ...
    def __init__(self, amount):
        super(FixedPerShare, self).__init__()
        self.__amount = amount

    def calculate(self, order, price, quantity):
        return self.__amount * quantity
